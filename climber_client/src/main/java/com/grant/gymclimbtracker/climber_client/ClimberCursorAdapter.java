...
public class ClimberCursorAdapter extends CursorAdapter {
    ...
    public ClimberCursorAdapter(Context context, Cursor c, int flags) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        ((TextView)view.findViewById(R.id.idListItem)).setText(String.valueOf(cursor.getInt(cursor.getColumnIndex(ClimbContract.Climbs._ID))));
